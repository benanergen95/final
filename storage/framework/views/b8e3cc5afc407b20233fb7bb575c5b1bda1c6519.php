...
?>
    ...
    <div class="jumbotron bg-white rounded-top rounded-bottom border border-secondry mx-2">
        ...
        <hr>
        <h3 class="text-center"><?php echo e($child->CfName); ?>'s results</h3>
        <div class="parMain">
            ...
            <div class="row justify-content-center">
               ...
               <div class="col-3 text-black lead  border border-secondary" style="background-color:#C0C0C0; font-size:1rem"><?php echo e($entries->BMI_v); ?></div>
               ...
               <?php if($weight==2): ?>
               <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RBmi == 1 ? $data2 : ($results->RBmi == 0 ? $data1 : $data3)); ?></div>
               <?php endif; ?>
 
               <?php if($weight==1): ?>
               <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RBmi == 1 ? $data2 : ($results->RBmi == 0 ? $data1 : $data3)); ?></div>
               <?php endif; ?>
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"><?php echo e($entries->fruits); ?></div>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"><?php echo e($recommendedF); ?></div>    
                <?php if($food==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RfruitsIntake == 0 ? $data1f : $data2f); ?></div>
                <?php endif; ?>
                <?php if($food==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RfruitsIntake == 0 ? $data1f : $data2f); ?></div>
                <?php endif; ?>            
            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"><?php echo e($entries->veggies); ?></div>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"><?php echo e($recommendedV); ?></div>
                <?php if($veggie==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RveggiesIntake == 0 ? $data1v :  $data2v); ?></div>
                <?php endif; ?>
                <?php if($veggie==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RveggiesIntake == 0 ? $data1v :  $data2v); ?></div>
                <?php endif; ?>
            </div>
        ...
        <!-- Exercise result-->
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#C0C0C0; font-size:1rem"><?php echo e(date('H:i', strtotime($entries->exercise))); ?></div>
                ...
                <?php if($exercise==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->Rexercise == 0 ? $data1e : $data2e); ?></div>
                <?php endif; ?>
                <?php if($exercise==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->Rexercise == 0 ? $data1e : $data2e); ?></div>
                <?php endif; ?>
            </div>
        ...
        <!-- Screen time result-->
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"><?php echo e($entries->screenTimeSD); ?></div>
                ...
                <?php if($screen==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RscreentimeSD == 0 ? $data1st : $data2st); ?></div>
                <?php endif; ?>
                <?php if($screen==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RscreentimeSD == 0 ? $data1st : $data2st); ?></div>
                <?php endif; ?>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"><?php echo e($entries->screenTimeNSD); ?></div>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#DCDCDC; font-size:1rem"> Less than 2 hours</div>
                <?php if($screen2==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RscreentimeNSD == 0 ? $data3st : $data4st); ?></div>
                <?php endif; ?>    
                <?php if($screen2==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RscreentimeNSD == 0 ? $data3st : $data4st); ?></div>
                <?php endif; ?>  
            </div>
            <!-- Sleep result-->
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#C0C0C0; font-size:1rem"><?php echo e(date('H:i', strtotime($entries->sleepSD))); ?></div>
                ...
                <?php if($time==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RStimeSD == 0 ? $data1slp : ($results->RStimeSD == 1 ? $data2slp : $data5slp)); ?></div>
                <?php endif; ?>
                <?php if($time==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RStimeSD == 0 ? $data1slp : ($results->RStimeSD == 1 ? $data2slp : $data5slp)); ?></div>
                <?php endif; ?>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#C0C0C0; font-size:1rem"><?php echo e(date('H:i', strtotime($entries->sleepNSD))); ?></div>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:#C0C0C0; font-size:1rem">Between 9 & 11 hours</div>
                <?php if($time2==0): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:lime; font-size:1rem"><?php echo e($results->RStimeNSD == 0 ? $data3slp : ($results->RStimeNSD == 1 ? $data4slp : $data6slp)); ?></div>    
                <?php endif; ?>
                <?php if($time2==1): ?>
                <div class="col-3 text-black lead  border border-secondary" style="background-color:orange; font-size:1rem"><?php echo e($results->RStimeNSD == 0 ? $data3slp : ($results->RStimeNSD == 1 ? $data4slp : $data6slp)); ?></div>    
                <?php endif; ?>
            </div>
    </div>
        <br>

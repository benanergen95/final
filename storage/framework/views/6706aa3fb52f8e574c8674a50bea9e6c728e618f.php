...
<form action="MentalHealth5" method="get">
<div class="question text-center">Question 2 - How often does the child feel hopeless?
<br>
...
<a href="MentalHealth3" class="previous">Previous Question</a>
</div>
<?php
 session_start();
 if(isset($_GET['mental'])){
  $_SESSION['mentalHealthButton'] = $_GET['mental'];
 }

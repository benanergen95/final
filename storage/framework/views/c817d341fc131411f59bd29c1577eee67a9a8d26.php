    ...
    <div class="jumbotron bg-white rounded-bottom border bg-secondary mx-2">
                ...
                <div class="col align-self-center">
                    ...
                    <div class="row justify-content-center  text-white">
                        <div class="col-10 lead bg-secondary py-2"
                             style="background-color:#e4e6e7"><?php echo e($exerciseMessage); ?></div>
                    </div>
        ...
        <div class="av1">
            <form>
                ...
                <button onclick="location.href = 'Exercise1'" type="button" class="btn btn-primary btn-lg ">Redo Test</button>
            </form>
        </div>
    </div><!-- /.container -->

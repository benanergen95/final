...
<form action="MentalHealth8" method="get">
<div class="question text-center">Question 5 - How often does the child seem to be having less fun?
<br>
<div>
...
<a href="MentalHealth6" class="previous">Previous Question</a>
</div>
<?php
 session_start();

...
<table>
    <tr>
        ...
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($entries->BMI_v); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($results->RBmi == 1 ? $data1 : ($results->RBmi == 0 ? $data1 : $data1)); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RBmi == 0 ? $data1 : ($results->RBmi == 1 ? $data2 : $data3)); ?></td>
    <tr>
        ...
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($entries->fruits); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($recommendedF); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RfruitsIntake == 0 ? $data1f : $data2f); ?></td>
    <tr>
    </tr style="background-color:#c1f0cc">
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Veggies Intake</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($entries->veggies); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($recommendedV); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RveggiesIntake == 0 ? $data1v :  $data2v); ?></td>
    <tr>
    </tr style="background-color:#f4bec3">
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Exercise</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e(date('H:i', strtotime($entries->exercise))); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">More than 1 hour</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->Rexercise == 0 ? $data1e : $data2e); ?></td>
    <tr>
        ...
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($entries->screenTimeSD); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Less than 2 hours</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RscreentimeSD == 0 ? $data1st : $data2st); ?></td>
    <tr>
    </tr style="background-color:#bbeff7">
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Screen Time (Weekend)</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e($entries->screenTimeNSD); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Less than 2 hours</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RscreentimeNSD == 0 ? $data3st : $data4st); ?></td>
    <tr>
        ...
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e(date('H:i', strtotime($entries->sleepSD))); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Between 9 & 11 hours</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RStimeSD == 0 ? $data1slp : ($results->RStimeSD == 1 ? $data2slp : $data5slp)); ?></td>
    <tr>
    </tr style="background-color:#f7bbd7">
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Sleep (Weekend)</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e(date('H:i', strtotime($entries->sleepNSD))); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Between 9 & 11 hours</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->RStimeNSD == 0 ? $data3slp : ($results->RStimeNSD == 1 ? $data4slp : $data6slp)); ?></td>
    <tr>
    </tr style="background-color:#f7bbd7">
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Mental Health</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd"><?php echo e((($results->MentalScore))); ?></td>
        <td style="padding:10px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd">Score less than 13</td>
        <td style="padding:10px; border-bottom: 1px solid #ddd"><?php echo e($results->MentalScore <= 13 ? $data8 : ($results->MentalScore >= 14 ? $data9 : $data9)); ?></td>
    <tr>

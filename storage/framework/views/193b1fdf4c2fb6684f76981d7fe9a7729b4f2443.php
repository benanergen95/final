...
<form action="MentalHealth16" method="get">
<div class="question text-center">Question 13 - How often does the child not understand other people's feelings?
<br>
<div>
...
<a href="MentalHealth14" class="previous">Previous Question</a>
</div>
<?php
 session_start();

...
<?php $__env->startSection('content'); ?>
    ...
    <div class="jumbotron bg-white rounded-bottom border border-secondary mx-2">
        <h2 class="text-center"><b>Weight</b></h2>
        <hr>
            ...
            <div class="row">
                <div class="col align-self-center">
                    ...
                    <div class="row justify-content-center  text-white">
                        <div class="col-10 lead bg-secondary py-2" style="background-color:#f4bec3"> <?php echo e($BMIc); ?></div>
        ...
        <div class="av1">
            <form>
                ...
                <button onclick="location.href = 'Weight2'" type="button" class="btn btn-primary btn-lg ">Redo Test</button>
            </form>
        </div>
    </div>
<?php $__env->stopSection(); ?>

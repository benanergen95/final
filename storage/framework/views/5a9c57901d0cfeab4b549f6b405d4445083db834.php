...
<?php $__env->startSection('content'); ?>
    ...
    <div class="jumbotron bg-white rounded-bottom border border-secondary mx-2">
        <h2 class="text-center">Screen Time</h2>
        <hr>
                ...
                <div class="col align-self-center">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-6 text-black lead border border-secondary"
                             style="background-color:#e4e6e7"><?php echo e($screenSDMessage); ?></div>
                        <div class="col-6 text-black lead  border border-secondary"
                             style="background-color:#e4e6e7"><?php echo e($screenNSDMessage); ?></div>
                    </div>
                    <br>
                    <div class="row justify-content-center  text-white">
        ...
        <div class="av1">
            <form>
                ...
                <button onclick="location.href = 'ScreenTime2'" type="button" class="btn btn-primary btn-lg ">Redo Test</button>
            </form>
        </div>
    </div>
<?php $__env->stopSection(); ?>

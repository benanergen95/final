...
<?php $__env->startSection('content'); ?>
    ...
    <div class="BOXtears">
        <h2 class="text-center">Mental Health 0 Page<span class="text-muted"></span></h2>
        <hr>
        <?php
            $data=DB::table('summernotes')->where("item_id","=",79)->value('content');
        ?>
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo e(url('editmental0')); ?>" method="post">
                        <div class="form-group">
                <textarea id="summernote" name="editmental0value" class="form-control">
                  <?php echo $data; ?>

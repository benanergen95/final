...
<form action="MentalHealth18" method="get">
<div class="question text-center">Question 15 - How often does the child blame other's for his/her troubles?
<br>
<div>
...
<a href="MentalHealth16" class="previous">Previous Question</a>
</div>
<?php
 session_start();

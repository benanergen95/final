...
<form action="MentalHealth14" method="get">
<div class="question text-center">Question 11 - How often does the child fight with other children?
<br>
<div>
...
<a href="MentalHealth12" class="previous">Previous Question</a>
</div>
<?php
 session_start();

...
<form action="MentalHealth13" method="get">
<div class="question text-center">Question 10 - How often does the child act as if driven by a motor?
<br>
<div>
...
<a href="MentalHealth11" class="previous">Previous Question</a>
</div>
<?php
 session_start();

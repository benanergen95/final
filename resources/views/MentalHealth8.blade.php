...
<form action="MentalHealth9" method="get">
<div class="question text-center">Question 6 - How often does the child fidget?
<br>
<div>
...
<a href="MentalHealth7" class="previous">Previous Question</a>
</div>
<?php
 session_start();
